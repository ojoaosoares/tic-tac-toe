...
function winTest(last_player) {
	...
	if(last_player == 2 && ((String(caixa0.classList).indexOf('x') != -1 && String(caixa1.classList).indexOf('x') != -1 && String(caixa2.classList).indexOf('x') != -1 ) || 
	...
	else if(last_player == 1 && ((String(caixa0.classList).indexOf('circle') != -1 && String(caixa1.classList).indexOf('circle') != -1 && String(caixa2.classList).indexOf('circle') != -1 ) || 
